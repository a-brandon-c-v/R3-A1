...
//Switch
const int PinDSwitch1= 13;
const int PinDSwitch2= 12;
...
if (digitalRead(PinDSwitch1)== LOW && digitalRead(PinDSwitch2)== LOW && digitalRead(PinDSwitch3)== LOW && digitalRead(PinDSwitch4)== LOW)
 ...
 //Turn Motor1 and Motor 2 FWD (CWX2) for 5 sec
  ...
  delay (5000);
 //Turn Motor1 and Motor 2 FULL STOP for 5 sec
...
else (digitalRead(PinDSwitch1)== HIGH && digitalRead(PinDSwitch2)== HIGH && digitalRead(PinDSwitch3)== HIGH && digitalRead(PinDSwitch4)== HIGH);{
   {
  digitalWrite(MotorPin1, LOW);
  digitalWrite(MotorPin2, LOW);  
  digitalWrite(MotorPin3, LOW);
